    ...
    document.querySelectorAll('.token.string').forEach(span => {
        ...
        if (texto.includes(url)) {
            ...
            if (parent) {
                ...
                spanLink.style.setProperty('background-color', 'rgba(0, 255, 255, 0.1)', 'important');
        ...
        <div class="footer-icons">
              ...
              <defs>
                <linearGradient id="yt-gradient" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stop-color="#ff00cc">
                    <animate attributeName="stop-color" values="#ff00cc;#3333ff;#00ffe7;#ff00cc" dur="6s" repeatCount="indefinite" />
                  </stop>
                  <stop offset="100%" stop-color="#00ffe7">
                    <animate attributeName="stop-color" values="#00ffe7;#ff00cc;#3333ff;#00ffe7" dur="6s" repeatCount="indefinite" />
                  </stop>
                </linearGradient>
              </defs>
              <path fill="url(#yt-gradient)" d="M365.257 67.393H95.744C42.866 67.393 0 110.259 0 163.137v134.728c0 52.878 42.866 95.744 95.744 95.744h269.513c52.878 0 95.744-42.866 95.744-95.744V163.137c0-52.878-42.866-95.744-95.744-95.744zm-64.751 169.663-126.06 60.123c-3.359 1.602-7.239-.847-7.239-4.568V168.607c0-3.774 3.982-6.22 7.348-4.514l126.06 63.881c3.748 1.899 3.683 7.274-.109 9.082z"/>
            </svg>
          </a>
          <a href="https://ko-fi.com/darkjake" target="_blank" title="Ko-fi" rel="noopener noreferrer" class="footer-icon" aria-label="Ko-fi">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
              ...
              <path fill="url(#kofi-gradient)" d="M23.881 8.948c-.773-4.085-4.859-4.593-4.859-4.593H.723c-.604 0-.679.798-.679.798s-.082 7.324-.022 11.822c.164 2.424 2.586 2.672 2.586 2.672s8.267-.023 11.966-.049c2.438-.426 2.683-2.566 2.658-3.734 4.352.24 7.422-2.831 6.649-6.916zm-11.062 3.511c-1.246 1.453-4.011 3.976-4.011 3.976s-.121.119-.31.023c-.076-.057-.108-.09-.108-.09-.443-.441-3.368-3.049-4.034-3.954-.709-.965-1.041-2.7-.091-3.71.951-1.01 3.005-1.086 4.363.407 0 0 1.565-1.782 3.468-.963 1.904.82 1.832 3.011.723 4.311zm6.173.478c-.928.116-1.682.028-1.682.028V7.284h1.77s1.971.551 1.971 2.638c0 1.913-.985 2.667-2.059 3.015z"/>
            </svg>
          </a>
